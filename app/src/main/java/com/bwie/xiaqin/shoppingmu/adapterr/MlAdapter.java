...
public class MlAdapter extends RecyclerView.Adapter<MlAdapter.ViewHolder> {
    ...
    private List<Prouduct.ResultBean.MlssBean.CommodityListBeanXX> list;

    public MlAdapter(Context context, List<Prouduct.ResultBean.MlssBean.CommodityListBeanXX> list) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.shou_ml_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.ml_image);
            textView = itemView.findViewById(R.id.ml_text_title);
            text_price = itemView.findViewById(R.id.ml_text_price);
        }
    }
}
