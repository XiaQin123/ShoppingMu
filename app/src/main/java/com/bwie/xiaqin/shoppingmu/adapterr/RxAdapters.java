...
public class RxAdapters extends RecyclerView.Adapter<RxAdapters.ViewHolder> {
    private Context context;
    private List<RxBean.ResultBean> list;

    public RxAdapters(Context context, List<RxBean.ResultBean> list) {
