...
public class MlAdapters extends RecyclerView.Adapter<MlAdapters.ViewHolder>{
    private Context context;
    private List<MlBean.ResultBean> list;

    public MlAdapters(Context context, List<MlBean.ResultBean> list) {
